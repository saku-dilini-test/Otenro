...
module.exports.sockets = {
  ...
  beforeConnect: function(handshake, callback) {


    sails.log.debug('connecting to socket.io ...');
  ...
  //
  //
  //// Use this option to set the data store socket.io will use to manage rooms/sockets/subscriptions:
  //// default: memory
  //
  //adapter: 'memory',
  //
