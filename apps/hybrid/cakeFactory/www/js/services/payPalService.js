/**
 * Created by udeshikaperera on 04/11/2015.
 */
angular.module('starter.payPalService', []);


angular.module('starter.payPalService').factory('PaypalService', ['$q', '$ionicPlatform', 'shopSettings', '$filter', '$timeout', function ($q, $ionicPlatform, shopSettings, $filter, $timeout) {
  var init_defer;
  /**
   * Service object
   * @type object
