var mobileApp = angular.module('mobileApp', ['angular-loading-bar','ngRoute', 'ngAnimate', 'pascalprecht.translate', 'ngCookies', 'ngSanitize']);
...
mobileApp.config(function($routeProvider) {
    $routeProvider
		...
		.when('/sweet', {
            templateUrl: 'tpl/SweetDonuts.html',
