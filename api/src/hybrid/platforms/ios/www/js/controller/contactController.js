mobileApp.controller('contactController', function($scope,$translate, $rootScope, appService,$http, $window) {
    ...
    $scope.marker="";
	$http.get(SERVER_URL + '/api/templates/getContactUs?appId='+$rootScope.appId)
		.success(function(data) {
			...
			$scope.mapUrl="https://maps.googleapis.com/maps/api/staticmap?center="+$scope.marker.latitude+","+$scope.marker.longitude+"&zoom=17&size=450x750&markers=color:red|Clabel:S|"
